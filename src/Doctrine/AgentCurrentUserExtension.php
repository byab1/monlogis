...
class AgentCurrentUserExtension implements QueryCollectionExtensionInterface, QueryItemExtensionInterface
{
    private $security;
    private $auth;
    ...
    private function addWhere(QueryBuilder $queryBuilder, string $resourceClass)
    {
        ...
        if (
            ($resourceClass === Agent::class || $resourceClass === Facture::class)
            &&
