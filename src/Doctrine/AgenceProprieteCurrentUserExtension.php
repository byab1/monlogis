...
class AgenceProprieteCurrentUserExtension implements QueryCollectionExtensionInterface, QueryItemExtensionInterface
{
    private $security;
    private $auth;
    ...
    private function addWhere(QueryBuilder $queryBuilder, string $resourceClass)
    {
        ...
        if (
            ($resourceClass === Agence::class || $resourceClass === Propriete::class)
            &&
